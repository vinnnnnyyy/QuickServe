...
<template>
  <div 
    v-if="totalPages > 1" 
    class="mt-8 px-4 sm:px-6 lg:px-6 xl:px-8 2xl:px-12"
  >
    <!-- Items info -->
    <p 
      v-if="showItemsInfo" 
      class="text-sm text-surface-600 text-center mb-4"
    >
    ...
    <div class="flex items-center justify-center gap-2">
      ...
      <button 
        ...
        class="px-3 py-2 rounded-lg border border-gray-200 text-surface-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
        ...
        <button 
          ...
          :class="[
            ...
            page === currentPage 
              ...
              : 'border border-gray-200 text-surface-700 hover:bg-gray-50'
          ]"
        >
          {{ page }}
        </button>
