...
<template>
  <AdminLayout 
    ...
    page-title="Add New Add-on"
    page-subtitle="Create a new customization option for menu items"
  >
      ...
      <form @submit.prevent="submitForm" class="space-y-8">
        ...
        <CardWrapper rounded="xl" padding="lg" shadow="sm">
          <div class="flex flex-col sm:flex-row items-center justify-end gap-4">
            ...
            >
              <span class="flex items-center justify-center gap-2">
                <span class="material-symbols-outlined text-lg">{{ form.processing ? 'hourglass_empty' : 'add_circle' }}</span>
                {{ form.processing ? 'Creating...' : 'Create Add-on' }}
              </span>
            </button>
          </div>
        </CardWrapper>
